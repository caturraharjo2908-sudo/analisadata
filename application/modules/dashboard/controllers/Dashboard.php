<?php
	...
	class Dashboard extends CI_Controller {
        ...
        public function pendidikanigd(){
            $periode = $this->input->post("selectperiode");
            $result    = $this->md->pendidikanigd($periode);
        ...
        public function pendidikanrj(){
            $periode = $this->input->post("selectperiode");
            $result    = $this->md->pendidikanrj($periode);
        ...
        public function pendidikanri(){
            $periode = $this->input->post("selectperiode");
            $result    = $this->md->pendidikanri($periode);
