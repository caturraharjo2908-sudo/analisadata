// let globalDataProviderOK   = [];

// datakunjunganprovider();
...
// $("#btnDownloadExcelProviderOK").on("click", function () {
//     exportToExcel(globalDataProviderOK, "Provider OK", "Provider_OK.xlsx");
// });

// function datakunjunganprovider(){
//     let selectperiode = $("select[name='selectperiode']").val();
//     $.ajax({
//         url      : url + "index.php/ok/kinerjaok/datakunjunganprovider",
//         type     : "POST",
//         dataType : "JSON",
...
//             globalDataProviderOK = result;

//             renderchartpie("grafikaggregateokprovider", result);
//         },
//         complete: function () {
//             Swal.close();
//         },
...
// //             const result       = (data.responResult || []).filter(item => item.STATUS_ID === '02');
// //             const tahun        = selectperiode;
// //             const bulanLengkap = ["01","02","03","04","05","06","07","08","09","10","11","12"];
// //             const namaBulan    = ["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"];


// //             const providerList = [...new Set(result.map(item => item.PROVIDER || "UNKNOWN"))];


// //             const dataMapProvider = {};

// //             namaBulan.forEach((_, idx) => {
// //                 dataMapProvider[idx] = {};

// //                 providerList.forEach(p => {
// //                     dataMapProvider[idx][p] = 0;
// //                 });
// //             });


// //             result.forEach(item => {
// //                 const bulanText   = item.TGL_TINDAKAN?.split('-')[1];                                         // JAN, FEB, dst
// //                 const bulanFormat = bulanText ? bulanText.charAt(0) + bulanText.slice(1).toLowerCase() : "";
// //                 const idx         = namaBulan.indexOf(bulanFormat);
// //                 const provider    = item.PROVIDER || "UNKNOWN";

// //                 if (idx === -1) return;

// //                 dataMapProvider[idx][provider] += 1;
// //             });


// //             const ChartdataMapProvider = namaBulan.map((nama, index) => {
// //                 const row = {
// //                     periode: nama
// //                 };

// //                 providerList.forEach(p => {
// //                     row[p] = dataMapProvider[index][p] || 0;
// //                 });

// //                 return row;
// //             });

// //             const seriesConfig = providerList.map(p => ({
// //                 name: p,
// //                 field: p
// //             }));

// //             const chartData = aggregateKunjunganBulanan(result);

// //             renderchartbar(
// //                 "grafikaggregateokprovider",
// //                 ChartdataMapProvider,
// //                 seriesConfig, // ✅ dynamic provider
// //                 "Periode Bulan",
// //                 "Jumlah Tindakan",
// //                 true
// //             );
...
// //             const chartDataProvider = Object.values(grouped);
...
// //             renderchartarea("grafikaggregateokprovider",chartDataProvider,"Periode Pelayanan","Waktu Tunggu (Menit)",["RANAP - TRANSFER"],["avgValue"],null,"",null,"Target SLA 1 Jam (60 Menit)",60);
...
function datatransaksi(){
    let selectperiode = $("select[name='selectperiode']").val();
    $.ajax({
        url       : url +"index.php/ok/kinerjaok/datatransaksi",
        data      : {selectperiode:selectperiode},
        type      : "POST",
        dataType  : "JSON",
        beforeSend: function () {
