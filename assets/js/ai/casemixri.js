...
$(document).on("keyup", "#fieldsearch", function () {
    filterTableByKeywords("#fieldsearch", "#resultdatacasemixri");
});
...
function casemixri(startDate, endDate){
    $.ajax({
        url       : url +"index.php/ai/casemixri/casemixri",
        ...
        success:function(data){
            ...
            $("#resultdatacasemixri").html(tableresult);
        },
        complete: function () {
            Swal.close();
        },
