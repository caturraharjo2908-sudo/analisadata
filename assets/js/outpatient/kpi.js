...
function datalamakonsultasi(){
    let selectperiode   = $("select[name='selectperiode']").val();
    $.ajax({
        url       : url + "index.php/outpatient/kpi/datalamakonsultasi",
        ...
        success: function (data) {
            ...
            const dataChartPendidikan = result.map(item => ({
                kategori: item.NAMADOKTER,
                qty     : item.AVG_KONSULTASI_MENIT
            }));

            renderBarHorizontal('grafiklamakonsultasi', 'Jumlah', dataChartPendidikan, 'kategori', 'qty', true);
        },
        complete: function () {
            Swal.close();
        },
...
function datapeakdokter(){
    let selectperiode = $("select[name='selectperiode']").val();

    $.ajax({
        url     : url + "index.php/outpatient/kpi/datapeakdokter",
        method  : "POST",
        dataType: "JSON",
        data    : { selectperiode: selectperiode },
